  ...
  render() {
    const about = (
      <p className="lead fs-6 fw-normal p-5 text-dark text-center">
        ...
        worked on UX projects from research to wireframing using the
        user-centered design model. Also, I code things from scratch by building
        projects using NodeJS, ExpressJS, Laravel, React & React Native. I have
